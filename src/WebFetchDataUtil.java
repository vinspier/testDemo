...
public class WebFetchDataUtil {
	...
	public static void main(String[] args) throws Exception{
		...
		WebFetchDataUtil.getConnection(url);
		//String orign = WebFetchDataUtil.read();
		JSONObject object = WebFetchDataUtil.fetchJsonObject();
		//JSONArray array = WebFetchDataUtil.fetchJsonArray();
		System.out.println(object.get("estates"));
	}
}
